...
class ViewBalanceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.viewBalanceAmountTextView).text = "${Balanceobject.balance.asCurrencyFormat()}"
        //view.findViewById<TextView>(R.id.viewBalanceLabelTextView).text = "Balance: $${String.format("%.2f",Balanceobject.balance)}"
